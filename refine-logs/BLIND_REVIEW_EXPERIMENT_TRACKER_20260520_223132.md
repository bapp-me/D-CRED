...
Updated: 20260520-223132
Output directory: `D:\code\diss_codex\D-CRED\outputs\blind_review_response_20260520-223108`
...
| BR205 | M2 | D-CRED ablation A4-A5 | PARTIAL | Capacity done; cash-flow done only if approval frontier exists. |
...
| BR501 | M5 | Cash-flow frontier data | PARTIAL | Available after clean cash-flow rerun produces approval frontier. |
| BR502 | M5 | Cash-flow frontier CI | PARTIAL | Implemented in cash-flow script month bootstrap. |
| BR503 | M5 | Coverage-constrained best policy | PARTIAL | Implemented in cash-flow script. |
